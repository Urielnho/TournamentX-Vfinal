...
export default function App() {
  ...
  return <div className="flex min-h-screen flex-col bg-white text-black selection:bg-black selection:text-white">
    ...
    <main className="flex-1 bg-[#f5f6f8] text-black">
      ...
      {currentView === 'profile' && authUser && <ProfileAthleteView user={userProfile} tournaments={tournaments} onUpdateUser={profile => void updateProfile(profile)} onNavigate={handleNavigate} />}
